...
powershell.exe "(Get-Content $env:userprofile\konspekt_pack\.obsidian\plugins\obsidian-pandoc\data.json) -replace 'testuser',(Split-Path -Path $env:userprofile -Leaf) | Out-File -encoding ASCII $env:userprofile\konspekt_pack\.obsidian\plugins\obsidian-pandoc\data.json"
...
powershell.exe "(Get-Content $env:userprofile\konspekt_pack\.obsidian\plugins\obsidian-pandoc-reference-list\data.json) -replace 'testuser',(Split-Path -Path $env:userprofile -Leaf) | Out-File -encoding ASCII $env:userprofile\konspekt_pack\.obsidian\plugins\obsidian-pandoc-reference-list\data.json"
